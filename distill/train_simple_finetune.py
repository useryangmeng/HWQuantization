...
def block_ap_finetune(
    ...
    logger.info("Starting simple block_ap fine-tune...")
    ...
    for block_index in range(len(layers_student)):
        ...
        if args.epochs > 0:
            ...
            for p in weight_parameters(qlayer):
            ...
            lr_schedule = CustomLRSchedule(args, int(total_training_iteration))
            ...
            for epoch in range(args.epochs):
                ...
                train_loss, gradient_norm = train_one_epoch(
                    qlayer, prefixed_key_values, attention_mask, position_ids,
                    loss_scaler, loss_func, lr_schedule, optimizer, dev, traincast,
...
def main():
    ...
    parser.add_argument("--output_dir", default="./log/simple_finetune", type=str, help="Logging directory")
    ...
    student_model = block_ap_finetune(student_model, prefixed_key_values, args, trainloader, valloader, logger)
