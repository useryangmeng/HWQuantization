...
class NativeScalerWithGradNormCount:
    ...
    def __init__(self):
        # Use NPU GradScaler if available, otherwise use CUDA, fallback to CPU
        try:
            import torch_npu
...
def cleanup_memory(verbos=True) -> None:
    ...
    def total_reserved_mem() -> int:
        # Use NPU memory management if available, otherwise use CUDA
        try:
            import torch_npu
    ...
    # Use NPU cache cleaning if available, otherwise use CUDA
    try:
        import torch_npu
