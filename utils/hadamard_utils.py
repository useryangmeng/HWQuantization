...
def random_hadamard_matrix(size, device):
    ...
    Q = torch.randint(low=0, high=2, size=(size,)).to(torch.float32)  # 使用NPU支持的float32
    Q = Q * 2 - 1
    Q = torch.diag(Q)
...
# # had60.pal, had108.pal, had140.pal,had148.pal2, had156.will, had172.will:
