...
def get_wikitext2(tokenizer, train_size, val_size, seed, seqlen, test_only):
    ...
    traindata = load_from_disk("/mnt/data1/PrefixQuant/dataset/wikitext-2-raw-v1/train")
    # testdata = load_dataset('wikitext', 'wikitext-2-raw-v1', split='test')
    testdata = load_from_disk("/mnt/data1/PrefixQuant/dataset/wikitext-2-raw-v1/test")
...
def get_c4(tokenizer, train_size, val_size, seed, seqlen, test_only):
    print("get_c4")
    try:
        traindata = load_from_disk("/mnt/data1/PrefixQuant/dataset/c4_shards/train_shard")
        valdata = load_from_disk("/mnt/data1/PrefixQuant/dataset/c4_shards/val_shard")
    except:
    ...
    for _ in range(256):
        while True:
            ...
            # 修复：需要确保序列长度至少比seqlen大1，这样才能有有效的起始位置范围
...
def get_redpajama(tokenizer, train_size, val_size, seed, seqlen):
    print("get_redpajama")
    try:
        traindata = load_from_disk("/mnt/data1/PrefixQuant/dataset/redpajama/train")   
    except:
